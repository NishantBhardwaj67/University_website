(() => {
    var n = {
                        ...
                        var g = setInterval(function() {
                            ...
                            if (t < 0) {
                                ...
                                if (_tutorobject.quiz_options.quiz_when_time_expires === "auto_submit") {
                                    ...
                                    f("button[name='quiz_answer_submit_btn']").prop("disabled", true);
        ...
        3419: () => {
            window.jQuery(document).ready(function(l) {
                ...
                var f = new Map;
                l(".tutor-sortable-list").on("sortchange", e);

                function e(t, e) {
                    var r = parseInt(l(this).closest(".quiz-attempt-single-question").attr("id").match(/\d+/)[0], 10);
                    if (!f.get(r)) {
                        f.set(r, true)
                    }
                }
                ...
                function v(t) {
                    ...
                    !Array.isArray(i) ? i = [] : 0;
                    if (u() !== "question_below_each_other") {
                    ...
                    if (h()) {
                        ...
                        e.each(function() {
                            ...
                            if (e === "radio" || e === "checkbox") {
                                ...
                                var n = t.is(":checked");
                                if (r) {
                                    t.closest(".tutor-quiz-answer-single").addClass("tutor-quiz-answer-single-correct").append(c(d("Correct Answer", "tutor"))).find(".tutor-quiz-answer-single-info:eq(1)").remove()
                                } else {
                                    if (t.prop("checked")) {
                ...
                function m(t) {
                    var e = true;
                    var r = t[0];
                    var n = l(r).find(".tutor-dropzone");
                    if (n.length > 0) {
                        Object.values(n).forEach(function(t) {
                            if (t instanceof Element && t.classList.contains("tutor-dropzone")) {
                                if (l(t).has("input").length === 0) {
                                    e = false
                                }
                            }
                        })
                ...
                function y(r, n) {
                    ...
                    if (t.length) {
                        var e = parseInt(r.attr("id").match(/\d+/)[0], 10);
                        var o = f.get(e);
                        var i = r.find(".tutor-draggable");
                        var a = r.find(".ui-sortable");
                        var u = t.find("input");
                        if (u.length) {
                            var c = u.attr("type");
                            if (c === "radio") {
                                if (t.find('input[type="radio"]:checked').length == 0) {
                                    r.find(".answer-help-block").html('<p style="color: #dc3545">'.concat(d("Please select an option to answer", "tutor"), "</p>"));
                                    n = false
                                }
                            } else if (c === "checkbox") {
                                if (t.find('input[type="checkbox"]:checked').length == 0) {
                                    r.find(".answer-help-block").html('<p style="color: #dc3545">'.concat(d("Please select at least one option to answer.", "tutor"), "</p>"));
                                    n = false
                                }
                            } else if (c === "text") {
                                u.each(function(t, e) {
                                    if (!l(e).val().trim().length) {
                                        r.find(".answer-help-block").html('<p style="color: #dc3545">'.concat(d("The answer for this question is required", "tutor"), "</p>"));
                                        n = false
                                    }
                                })
                            }
                ...
                l(document).on("click", ".tutor-quiz-answer-next-btn, .tutor-quiz-answer-previous-btn", function(t) {
                    ...
                    var i = parseInt(n.closest(".quiz-attempt-single-question").attr("id").match(/\d+/)[0], 10);
                    var a = n.closest(".quiz-attempt-single-question").attr("data-next-question-id");
                    var u = true;
                    u = y(o, u);
                    if (!u) {
                        return
                    ...
                    if (a) {
                        ...
                        if (s && s.length) {
                            ...
                            if (l(".tutor-quiz-questions-pagination").length) {
                                ...
                                l('.tutor-quiz-questions-pagination a[href="' + a + '"]').addClass("active")
                            }
                            e.text(r + 1)
                        }
                    }
                ...
                l(document).on("submit", "#tutor-answering-quiz", function(t) {
                    ...
                    if (_tutorobject.quiz_options.quiz_when_time_expires === "auto_submit" && l("#tutor-quiz-time-update").hasClass("tutor-quiz-time-expired")) {
                        o = true;
                        i = true
                    }
                    if (o && i) {
                        var a = 500;
                        if (h() && u() === "question_below_each_other") {
                            a = p();
                ...
                l(document).on("click", "a", function(t) {
                    ...
                    if (o.length > 0 && o.text() != "EXPIRED") {
                        ...
                        var n;
                        var e = {
                            title: d("Abandon Quiz?", "tutor"),
                            description: d("Do you want to abandon this quiz? The quiz will be submitted partially up to this question if you leave this page.", "tutor"),
                            buttons: {
                                keep: {
                                    title: d("Yes, leave quiz", "tutor"),
                                    id: "leave",
                                    ...
                                    callback: function t() {
                                        ...
                                        l.ajax({
                                            ...
                                            data: e,
                                            beforeSend: function t() {
                                                document.querySelector("#tutor-popup-leave").innerHTML = d("Leaving...", "tutor")
                                            },
                                            success: function t(e) {
                                                if (e.success) {
                                                    location.href = r
                                                } else {
                                                    alert(d("Something went wrong", "tutor"))
                                                }
                                            },
                                            error: function t() {
                                                alert(d("Something went wrong", "tutor"));
    ...
    (() => {
        Ot.o = (t, e) => Object.prototype.hasOwnProperty.call(t, e)
    })();
    (() => {
        Ot.r = t => {
    ...
    (() => {
        ...
        function o(t, e) {
            ...
            if (r === "Object" && t.constructor) r = t.constructor.name;
            if (r === "Map" || r === "Set") return Array.from(t);
            if (r === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)) return a(t, e)
        }
        ...
        document.addEventListener("DOMContentLoaded", function(t) {
            ...
            var k = document.getElementById("tutor-assignment-file-upload");
            if (k) {
                k.addEventListener("change", S)
            }

            function S() {
                var t;
                var e = T(k.files).reduce(function(t, e) {
                    return t + e.size
                }, 0);
        ...
        var ct = wp.i18n.__;
        var st = ["keyword", "course_order", "tutor-course-filter-level", "tutor-course-filter-tag", "tutor-course-filter-category", "tutor-course-filter-price", "course_filter", "supported_filters", "current_page", "action"];
        var lt = function t(o) {
        ...
        window.jQuery(document).ready(function(h) {
            var v = window.wp.i18n.__;
            var m = h("[tutor-course-filter] form");
            if (!m.length) {
                return
            }
            var y = h("[tutor-course-list-container]");
            var g = h(".tutor-courses-wrap").data("tutor_courses_meta") || {};
            var b = {};
            ...
            var e = function t() {
                ...
                var n = j();
                var o = Object.assign(m.serializeObject(), b, g);
                ...
                m.find("[action-tutor-clear-filter]").closest(".tutor-widget-course-filter").removeClass("tutor-d-none");
                if (!("category" in o.supported_filters)) {
                    var i = "tutor-course-filter-category";
                    ...
                    if (a.length > 0) {
                        ...
                        o["tutor-course-filter-category"] = x(new Set(u))
                    } else {
                        o["tutor-course-filter-category"] = JSON.parse(h("#course_filter_categories").val())
                    }
                }
                var c = "tutor-course-filter-exclude-ids";
                ...
                if (s.length > 0) {
                    ...
                    o["tutor-course-filter-exclude-ids"] = x(new Set(l))
                } else {
                    if (h("#course_filter_exclude_ids").length) {
                        o["tutor-course-filter-exclude-ids"] = JSON.parse(h("#course_filter_exclude_ids").val())
                    }
                }
                var d = "tutor-course-filter-post-ids";
                var f = Object.keys(n).filter(function(t) {
                    return t.includes(d)
                });
                var p = [];
                if (f.length > 0) {
                    ...
                    o["tutor-course-filter-post-ids"] = x(new Set(p))
                } else {
                    if (h("#course_filter_post_ids").length) {
                        o["tutor-course-filter-post-ids"] = JSON.parse(h("#course_filter_post_ids").val())
                    }
                }
                h.ajax({
                    url: window._tutorobject.ajaxurl,
                    ...
                    success: function t(e) {
                        if (!e.success) {
                            y.html(v("Could not load courses", "tutor"));
                            return
                        }
                        y.html(e.data.html).find("nav").css("display", "flex")
                    }
                })
            };
            h("[tutor-toggle-course-filter]").on("click", function(t) {
                t.preventDefault();
                h("body").toggleClass("tutor-course-filter-open");
                if (h(".tutor-course-filter-backdrop").length == 0) {
                    h("body").append(h('<div class="tutor-course-filter-backdrop" area-hidden="true"></div>').hide().fadeIn(150))
                }
            });
            h("[tutor-hide-course-filter]").on("click", function(t) {
                t.preventDefault();
                h("body").removeClass("tutor-course-filter-open")
            });
            var t = document.querySelectorAll(".tutor-course-list-enroll");
            t.forEach(function(t) {
                t.onclick = function() {
                    var e = nt(P().mark(function t(r) {
                        var n, o, i, a, u, c, s, l;
                        return P().wrap(function t(e) {
                            while (1) switch (e.prev = e.next) {
                                case 0:
                                    r.preventDefault();
                                    n = v("Something went wrong, please try again!", "tutor");
                                    o = r.target;
                                    i = [{
                                ...
                                case 13:
                                    ...
                                    if (s) {
                                        tutor_toast(v("Success", "tutor-pro"), l, "success");
                                        window.location.href = o.href
                                    } else {
                                        tutor_toast(v("Failed", "tutor-pro"), l ? l : n, "error")
                                    }
                                    e.next = 20;
                                    break;
                                case 19:
                                    tutor_toast(v("Error", "tutor-pro"), v(n), "error");
                                case 20:
                                    o.classList.remove("is-loading");
                        ...
                        return N().wrap(function t(e) {
                            while (1) switch (e.prev = e.next) {
                                case 0:
                                    ...
                                    n = m("Something went wrong, please try again", "tutor");
                                    o = new FormData;
                                ...
                                case 14:
                                    ...
                                    if (a.success) {
                                        ...
                                        if (a.data.error_message) {
                                            tutor_toast(m("Failed", "tutor"), a.data.error_message, "error")
                                        } else {
                                            tutor_toast(m("Failed", "tutor"), n, "error")
                                        }
                                    }
                                    e.next = 19;
                                    break;
        ...
        jQuery(document).ready(function(l) {
            ...
            var o = {
                ...
                track_player: function t() {
                    ...
                    if (typeof Plyr !== "undefined") {
                        ...
                        var s = new Plyr(this.player_DOM, {
                            ...
                            listeners: St({}, u.isRequiredPercentage() && {
                                seek: function t(e) {
                                    ...
                                    if (r > o) {
                                        e.preventDefault();
                                        tutor_toast(d("Warning", "tutor"), d("Forward seeking is disabled", "tutor"), "error");
                                        return false
                                    }
                                    return true
                                }
                ...
                disable_complete_lesson_btn: function t() {
                    ...
                    if (i < o) {
                        ...
                        a.wrap('<div class="tooltip-wrap"></div>').after('<span class="tooltip-txt tooltip-bottom">'.concat(kt(d("Watch at least %s% to complete the lesson.", "tutor"), e.required_percentage), "</span>"))
                    }
                },
                ...
                getTargetTime: function t(e, r) {
                    if (y(r) === "object" && (r.type === "input" || r.type === "change")) {
            ...
            var a = l(".quiz-draggable-rand-answers").length;
            if (a) {
                ...
                l.ajax({
                    ...
                    success: function t(e) {
                        ...
                        if (e.success) {
                            ...
                            tutor_toast(d("Request Successful", "tutor"), d("Your request has been submitted. Please wait for the administrator's response.", "tutor"), "success");
                            setTimeout(function() {
                                location.reload()
                            }, 500)
                        } else {
            ...
            l(document).on("submit", "#tutor_assignment_submit_form", function(t) {
                ...
                if (e.trim().length < 1) {
                    t.preventDefault();
                    tutor_toast(d("Warning", "tutor"), d("Assignment answer is required.", "tutor"), "error");
                    setTimeout(function() {
            ...
            var c = l('.tutor-frontend-builder-course-price [name="tutor_course_price_type"]');
            if (c.length == 0) {
            ...
            var s = document.getElementById("tutor-reuseable-snackbar");
            if (s) {
                setTimeout(function() {
                    s.classList.add("tutor-snackbar-show")
                }, 1e3)
            }
